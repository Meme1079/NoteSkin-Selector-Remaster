...
makeLuaText('pa1', 'Colored', 0, 775+12+15, 515)
setTextFont('pa1', 'sonic.ttf')
setTextSize('pa1', 25)
setObjectCamera('pa1', 'camHUD')
setProperty('pa1.antialiasing', false)
addLuaText('pa1')

makeLuaSprite('a', 'ui/buttons/preview anim/previewAnimSelection_button', 775+12, 500)
scaleObject('a', 0.5, 0.5)
setObjectCamera('a', 'camHUD')
setProperty('a.antialiasing', false)
addLuaSprite('a')

makeAnimatedLuaSprite('d', 'ui/buttons/preview anim/previewAnimIcon_button', (775+(12*31))-1, 500)
addAnimationByPrefix('d', 'static', 'skinanim-static', 24, false)
addAnimationByPrefix('d', 'pressed', 'skinanim-pressed', 24, false)
addAnimationByPrefix('d', 'hovered-static', 'skinanim-hovered-static', 24, false)
addAnimationByPrefix('d', 'hovered-pressed', 'skinanim-hovered-pressed', 24, false)
playAnim('d', 'confirm', true)
scaleObject('d', 0.5, 0.5)
setObjectCamera('d', 'camHUD')
setProperty('d.antialiasing', false)
addLuaSprite('d')

makeAnimatedLuaSprite('c', 'ui/buttons/preview anim/previewAnimSkinNotes_button', 775+(12*31), 500)
addAnimationByPrefix('c', 'strums', 'notes-strums', 24, false)
addAnimationByPrefix('c', 'confirm', 'notes-confirm', 24, false)
addAnimationByPrefix('c', 'pressed', 'notes-pressed', 24, false)
addAnimationByPrefix('c', 'colored', 'notes-colored', 24, false)
playAnim('c', 'confirm', true)
scaleObject('c', 0.5, 0.5)
