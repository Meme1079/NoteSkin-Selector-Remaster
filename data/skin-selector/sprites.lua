...
makeAnimatedLuaSprite('selectionSkinButton_player', 'checkboxanim', 775 + 12, 315)
addAnimationByPrefix('selectionSkinButton_player', 'check', 'checkbox finish0', 24, false)
addAnimationByPrefix('selectionSkinButton_player', 'checking', 'checkbox anim0', 24, false)
addAnimationByPrefix('selectionSkinButton_player', 'unchecking', 'checkbox anim reverse0', 24, false)
addAnimationByPrefix('selectionSkinButton_player', 'uncheck', 'checkbox0', 24, false)
...
addOffset('selectionSkinButton_player', 'check', 34.5, 36 + (math.pi - 3))
addOffset('selectionSkinButton_player', 'checking', 48.5, 42)
addOffset('selectionSkinButton_player', 'unchecking', 44.5, 44)
addOffset('selectionSkinButton_player', 'uncheck', 33.3, 32.2)
setProperty('selectionSkinButton_player.antialiasing', false)
addLuaSprite('selectionSkinButton_player')

makeAnimatedLuaSprite('selectionSkinButton_opponent', 'checkboxanim', 775 + 12 + (80*2.9), 315)
addAnimationByPrefix('selectionSkinButton_opponent', 'check', 'checkbox finish0', 24, false)
addAnimationByPrefix('selectionSkinButton_opponent', 'checking', 'checkbox anim0', 24, false)
addAnimationByPrefix('selectionSkinButton_opponent', 'unchecking', 'checkbox anim reverse0', 24, false)
addAnimationByPrefix('selectionSkinButton_opponent', 'uncheck', 'checkbox0', 24, false)
playAnim('selectionSkinButton_opponent', 'uncheck')
scaleObject('selectionSkinButton_opponent', 0.4, 0.4)
setObjectCamera('selectionSkinButton_opponent', 'camHUD')
addOffset('selectionSkinButton_opponent', 'check', 34.5, 36 + (math.pi - 3))
addOffset('selectionSkinButton_opponent', 'checking', 48.5, 42)
addOffset('selectionSkinButton_opponent', 'unchecking', 44.5, 44)
addOffset('selectionSkinButton_opponent', 'uncheck', 33.3, 32.2)
