...
addAnimationByPrefix('mouseTexture', 'idle', 'idle0')
addAnimationByPrefix('mouseTexture', 'idleClick', 'idleClick')
addAnimationByPrefix('mouseTexture', 'hand', 'hand')
addAnimationByPrefix('mouseTexture', 'handClick', 'handClick')
